...
public class PlayerGrowth {
  ...
  public void Calculate() {
    props.Hp1 = (long)(PlayerClass.HpRatio + (props.Level / (1 + PlayerClass.HpBase) + PlayerClass.HpAcc) * props.Level);
    props.Mp1 = (long)(PlayerClass.MpRate + (props.Level / (1 + PlayerClass.MpBase) + PlayerClass.MpAcc) * PlayerClass.MpRate * props.Level);
    props.Exp1 = (long)(props.Level * ExpConst * ExpFactor * (props.Level * 1.1));
